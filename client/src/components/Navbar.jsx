  ...
  return (
    <div>
       ...
       :<button onClick={()=>navigate('/login')}
        className='flex  gap-2 border border-gray-500 rounded-full px-6 py-2 text-gray-800 hover:bg-gray-100 transition-all '>Login <img src={assets.arrow_icon} alt="" /></button>
       }
