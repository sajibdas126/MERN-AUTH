    ...
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-sm text-indigo-300'>
          ...
          <form>
            ...
            {state === 'Sign Up' && (
              <div className='flex items-center gap-3 mb-4 w-full px-5 py-2 rounded-full bg-[#333A5c]'>
            ...
            <button className='w-full py-2.5 rounded-full text-white font-medium bg-gradient-to-r from-indigo-500 to-indigo-900 cursor-pointer'>
              {state}
            </button>
          </form>
